...
<body>
    ...
    <div style="background-color: #FFCC99; height: 474px; z-index: 1; left: 10px; top: 15px; position: absolute; width: 707px;">
        ...
        <asp:Button ID="BtnBaja" runat="server" style="z-index: 1; left: 267px; top: 81px; position: absolute" Text="Baja de usuarios" />
        ...
        <asp:DropDownList ID="DDLUsuarios" runat="server" style="z-index: 1; left: 269px; top: 149px; position: absolute" Visible="False">
        </asp:DropDownList>
        ...
        <asp:Button ID="BtnEjecuta" runat="server" Enabled="False" OnClick="BtnEjecuta_Click" style="z-index: 1; left: 471px; top: 297px; position: absolute" Text="Ejecutar operación" />
